...
class _RegisterPage extends ConsumerState<RegisterPage> {
  ...
  final _controllerSchollName = SCTextInputController();
                              ...
                              SizedBox(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      const SCText('회원가입',
                                          textStyle:
                                              SCTextStyle.font_24px_w700_h100),
                                      SizedBox(
                                          width: 100,
                                          child: Row(
                                            mainAxisAlignment:
                                        ...
                                        child: Row(
                                          children: [
                                            SizedBox(
                                              ...
                                              child: SCTextInput(
                                                state:
                                                    SCTextInputState.disabled,
                                                textInputAction:
                                                    TextInputAction.next,
                                                controller:
                                                    _controllerSchollName,
                                                placeHolder: '학교 찾기를 진행해주세요.',
                                                focusNode: FocusNode(),
                                                onFocusOffCallback: (value) {
                                                  notifier.setter(
                                                      schoolName: value);
